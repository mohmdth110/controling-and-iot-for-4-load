...
#define ssid "thabet110"  //WiFi SSID
#define password "0935612130"  //WiFi Password
...
#define wifiLed A0//GPIO 2

int load1=1, load2=1, load3=1, load4=1, Power1;
...
void Switch_Read(){
     ...
     if(digitalRead(Switch1) == LOW){Power1=0;
     update_power_status();
      load1 = !load1;
      Relays(); 
...
else if(digitalRead(Switch3) == LOW){Power1=0;
      update_power_status();
      load3 = !load3;
      Relays();
